# Migration guide from Foundry 2.9 to 2.10

The main feature of Foundry 2.10 is the deprecation of the `ResetDatabase` trait, in favor of a `#[ResetDatabase]` attribute,
...
return RectorConfig::configure()
    ->withPaths(['tests'])
    ->withSets([FoundrySetList::FOUNDRY_2_10])
;
```
