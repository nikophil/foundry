...
{
    private function __construct(private string $namespace, private bool $test, private bool $persisted, private bool $allFields, private string $class, private Generator $generator)
    {
    }
