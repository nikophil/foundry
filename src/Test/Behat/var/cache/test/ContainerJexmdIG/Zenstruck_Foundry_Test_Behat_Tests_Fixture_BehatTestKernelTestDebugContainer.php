 ...
 */
class Zenstruck_Foundry_Test_Behat_Tests_Fixture_BehatTestKernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            '.zenstruck_foundry.behat.factory_resolver' => 'get_ZenstruckFoundry_Behat_FactoryResolverService',
            '.zenstruck_foundry.behat.object_registry' => 'get_ZenstruckFoundry_Behat_ObjectRegistryService',
            '.zenstruck_foundry.configuration' => 'get_ZenstruckFoundry_ConfigurationService',
            '.zenstruck_foundry.story.fixture_resolver' => 'get_ZenstruckFoundry_Story_FixtureResolverService',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController' => 'getRedirectControllerService',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController' => 'getTemplateControllerService',
            'Zenstruck\\Foundry\\Persistence\\PersistenceManager' => 'getPersistenceManagerService',
            'Zenstruck\\Foundry\\Test\\Behat\\FoundryContext' => 'getFoundryContextService',
            'Zenstruck\\Foundry\\Test\\Behat\\Tests\\Fixture\\ResetDisabledTestContext' => 'getResetDisabledTestContextService',
            'Zenstruck\\Foundry\\Test\\Behat\\Tests\\Fixture\\TestFoundryContext' => 'getTestFoundryContextService',
            'Zenstruck\\Foundry\\Tests\\Fixture\\App\\Controller\\CreateGenericModel' => 'getCreateGenericModelService',
            'Zenstruck\\Foundry\\Tests\\Fixture\\App\\Controller\\DeleteGenericModel' => 'getDeleteGenericModelService',
            'Zenstruck\\Foundry\\Tests\\Fixture\\App\\Controller\\HelloWorldController' => 'getHelloWorldControllerService',
            'Zenstruck\\Foundry\\Tests\\Fixture\\App\\Controller\\UpdateGenericModel' => 'getUpdateGenericModelService',
        ...
        $this->aliases = [
            'Zenstruck\\Foundry\\Test\\Behat\\Tests\\Fixture\\BehatTestKernel' => 'kernel',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/psr/log/src/NullLogger.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.terminate', [#[\Closure(name: '.foundry.persistence.objects_tracker', class: 'Zenstruck\\Foundry\\Persistence\\PersistedObjectsTracker')] fn () => ($container->privates['.foundry.persistence.objects_tracker'] ??= new \Zenstruck\Foundry\Persistence\PersistedObjectsTracker()), 'refresh'], 0);
        $instance->addListener('console.terminate', [#[\Closure(name: '.foundry.persistence.objects_tracker', class: 'Zenstruck\\Foundry\\Persistence\\PersistedObjectsTracker')] fn () => ($container->privates['.foundry.persistence.objects_tracker'] ??= new \Zenstruck\Foundry\Persistence\PersistedObjectsTracker()), 'refresh'], 0);
        $instance->addListener('Symfony\\Component\\Messenger\\Event\\WorkerMessageHandledEvent', [#[\Closure(name: '.foundry.persistence.objects_tracker', class: 'Zenstruck\\Foundry\\Persistence\\PersistedObjectsTracker')] fn () => ($container->privates['.foundry.persistence.objects_tracker'] ??= new \Zenstruck\Foundry\Persistence\PersistedObjectsTracker()), 'refresh'], 0);
        $instance->addListener('Zenstruck\\Foundry\\Persistence\\Event\\AfterPersist', [#[\Closure(name: '.foundry.persistence.objects_tracker', class: 'Zenstruck\\Foundry\\Persistence\\PersistedObjectsTracker')] fn () => ($container->privates['.foundry.persistence.objects_tracker'] ??= new \Zenstruck\Foundry\Persistence\PersistedObjectsTracker()), 'afterPersistHook'], 0);
        $instance->addListener('Zenstruck\\Foundry\\Story\\Event\\StateAddedToStory', [#[\Closure(name: '.zenstruck_foundry.behat.object_registry', class: 'Zenstruck\\Foundry\\Test\\Behat\\ObjectRegistry')] fn () => ($container->services['.zenstruck_foundry.behat.object_registry'] ?? $container->load('get_ZenstruckFoundry_Behat_ObjectRegistryService')), 'storeAfterStateAddedToStory'], 0);
    ...
    protected static function getArgumentResolverService($container)
    {
        return $container->privates['argument_resolver'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($container->privates['argument_metadata_factory'] ??= new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory()), new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['argument_resolver.datetime'] ??= new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\DateTimeValueResolver(NULL));
    ...
    {
        $container->privates['controller_resolver'] = $instance = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($container, ($container->privates['logger'] ??= new \Psr\Log\NullLogger()));
    ...
    protected static function getUriSignerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct('S3CRET', '_hash', '_expiration', NULL) && false ?: $lazyLoad);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Zenstruck_Foundry_Test_Behat_Tests_Fixture_BehatTestKernelTestDebugContainer.xml'),
        ...
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'ZenstruckFoundryBundle' => [
                    'path' => '/home/niko/works/github.com/zenstruck/foundry',
            ...
            'kernel.container_class' => 'Zenstruck_Foundry_Test_Behat_Tests_Fixture_BehatTestKernelTestDebugContainer',
            ...
            'zenstruck_foundry.faker.seed' => NULL,
            'zenstruck_foundry.faker.manage_seed' => true,
            'zenstruck_foundry.persistence.flush_once' => true,
            'zenstruck_foundry.enable_auto_refresh_with_lazy_objects' => true,
            'console.command.ids' => [
